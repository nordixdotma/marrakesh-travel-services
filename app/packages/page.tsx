...
export default function PackagesPage() {
  ...
  return (
    <main className="w-full">
      <Header />
      <PageHero title="Packages" backgroundImage="https://images.unsplash.com/photo-1609281362702-f46a060b2044?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
