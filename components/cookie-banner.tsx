        ...
        {!showPreferences ? (
          ...
          <div className="p-5 md:p-6">
            <div className="flex items-start gap-4">
              <div className="p-3 rounded-xl bg-primary/10 shrink-0 hidden md:flex">
              ...
              <div className="flex-1 space-y-4">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  <Button
                    ...
                    className="rounded-full px-6 h-10 font-medium shadow-sm"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 text-sm text-gray-500 hover:text-gray-700 px-3 py-2 rounded-full hover:bg-gray-50 transition-colors"
                  >
          ...
          <div className="p-5 md:p-6">
            ...
            <div className="space-y-3 mb-5">
              ...
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-xl">
                ...
                <div className="text-xs text-gray-400 font-medium px-2 py-1 bg-gray-200 rounded-full">
