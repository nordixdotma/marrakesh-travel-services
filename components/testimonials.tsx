...
const testimonials = [
  ...
  },
  {
    ...
    text: "We recommend Marrakesh Travel Services to all our guests. They never disappoint! Consistent quality and reliability every single time.",
    rating: 5,
    image: "/profile-man.jpg",
    date: "2 months ago",
    platform: "tripadvisor",
          ...
          <div className="flex items-center justify-center gap-6 mt-6">
            <div className="flex items-center gap-2">
              <a 
                ...
                className="flex items-center bg-white px-4 py-2 rounded-lg shadow-sm border-2 border-transparent hover:border-primary hover:bg-primary/5 transition-all duration-300"
              >
              ...
              >
                ...
                <div className="text-left">
                  <div className="flex items-center">
                    ...
                    <div className="flex ml-2">
                      {[...Array(5)].map((_, i) => (
                        <div key={i} className="w-4 h-4 rounded-full bg-green-500 mx-0.5"></div>
                      ))}
                    </div>
                  </div>
